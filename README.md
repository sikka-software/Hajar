...
[![Node.js CI](https://github.com/sikka-software/Hajar/workflows/build/badge.svg)](https://github.com/sikka-software/Hajar/actions?query=workflow%3A%22build%22)
[![Coverage Status](https://coveralls.io/repos/github/sikka-software/Hajar/badge.svg?branch=master)](https://coveralls.io/github/sikka-software/Hajar?branch=master)
...
`@sikka/hajar` can be imported to your project with `npm`:
...
```javascript
const hajar = require('@sikka/hajar')
```

or import (JavaScript ES module):

```javascript
import * as hajar from '@sikka/hajar'
```

The appropriate version for browser or node is automatically exported.

You can also download the [IIFE bundle](https://raw.githubusercontent.com/sikka-software/Hajar/master/dist\bundles\iife.js), the [ESM bundle](https://raw.githubusercontent.com/sikka-software/Hajar/master/dist\bundles\esm.min.js) or the [UMD bundle](https://raw.githubusercontent.com/sikka-software/Hajar/master/dist\bundles\umd.js) and manually add it to your project, or, if you have already installed `@sikka/hajar` in your project, just get the bundles from `node_modules/@sikka/hajar/dist/bundles/`.
